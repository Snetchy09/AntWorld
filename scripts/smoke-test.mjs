...
for (const needle of ['<link rel="stylesheet" href="./src/styles.css"', '<script type="module" src="./src/main.js"', '#game', 'Next Run', 'drawAnt', 'generateTerrain', 'randomGenome', 'carve(']) {
